...
*Página em construção. Em breve: cada um dos 15 passos descrito em detalhe com exemplos, antipadrões e heurísticas de quando cada spec merece detalhamento.*

Enquanto isso, uma visão rápida da estrutura:
...
Quando o passo 15 é executado, volta-se ao passo 1. A cadeia é um ciclo.
