...
- **Intenção** (passos 1-2) responde a *porquê este sistema deve existir, para quem, e o que ele expressamente não é*. O *não-intenção* é tão importante quanto o propósito — delimita o escopo e protege contra *feature creep*.
